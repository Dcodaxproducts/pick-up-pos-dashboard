...
const TableQrCode = ({ table }) => {
  ...
  // const url = `https://qr-code.hostdonor.com/${qrCodeType}?${params.toString()}`;
  // const url = `https://3bxk4r4p.inc1.devtunnels.ms:5173/${qrCodeType}/?${params.toString()}`;
  const url = `https://qr-code.hostdonor.com/?${params.toString()}`;
